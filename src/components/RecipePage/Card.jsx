  ...
  return (
    <div className="border border-gray-800 rounded-lg shadow-lg inline-block text-sm h-fit p-3 w-[250px] flex-grow">
      ...
      <div className='flex justify-between mt-1'>
        ...
        <Link to={`/recipes/${recipe._id}`} className='text-[12px] flex justify-between items-center bg-green-600 px-2 py-1 rounded-lg text-white hover:bg-green-700 transition duration-300'>
